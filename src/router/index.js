...
import Maps from '../views/client/map'
import About from '../views/client/about'
import Contract from '../views/client/contract'
...
import Admin_picture_add from '../views/admin/admin_picture_add'
import Admin_echarts from '../views/admin/admin_echarts'
Vue.use(Router)
    ...
    routes: [{
        ...
        },
        {
            ...
            children: [{
                ...
                {
                    path: '/admin_picture_add',
                    name: 'Admin_picture_add',
                    component: Admin_picture_add
                },
                {
                    path: '/admin_echarts',
                    name: 'Admin_echarts',
                    component: Admin_echarts
                }
            ]
        }
    ]
