      ...
      <div class="right">
        ...
        <div class="right-item logined" v-show="userCookie">
          <!-- <div v-show="Logined"> -->
            ...
            <p v-else>欢迎来到ai租房中介网</p>
            <p class="goAdmin" @click="logout">退出</p>
          <!-- </div> -->
        </div>
        <div class="right-item link" >
    <p>有租房及相关的问题，请QQ联系<a href="tencent://message/?uin=1002726239&Site=sc.chinaz.com&Menu=yes" >管理员</a>。（请点击管理员）</p>
    <span>还可以拨打联系人电话号码：17826170039 进行咨询</span>
    </div>
